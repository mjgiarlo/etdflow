...
describe Author::SubmissionsDashboardView do

  let(:existing_author) { create :author }
  let(:view_for_existing_author) { Author::SubmissionsDashboardView.new existing_author }
  let(:new_author) { Author.new }
  let(:view_for_new_author) { Author::SubmissionsDashboardView.new new_author }
